 ...
 */
@WebServlet("/GestionStadeServlet")
public class GestionStadeServlet extends HttpServlet {
...
private GestionStade gStade = new GestionStade();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.getWriter().append("Served at: ").append(request.getContextPath()+ " taille" +l.size()) ;
	}
