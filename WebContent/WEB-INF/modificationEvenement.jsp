...
<%@ include file="header.jsp" %>
  ...
  <div class="bg-primary text-center d-flex h-100 align-items-center">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h1 class="display-1 text-white">Modifier un evenement</h1>
          <p class="lead text-white">Choisir un evenement :</p>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
        ...
        <div class="col-md-6">
          ...
          <form class="form-inline w-50 h-75">
            ...
            <div class="form-group"><label>Categorie</label>
              <input type="text" class="form-control" placeholder="Entrez la categorie" name="categorie"> </div>
            <div class="form-group"><label>telephone</label>
              <input type="text" class="form-control" placeholder="entrez le telephone" name="telephone"> </div>
